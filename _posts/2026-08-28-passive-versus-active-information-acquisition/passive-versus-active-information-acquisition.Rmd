...
description: |
  Using what we know to choose what to observe next. 
preview: ./bayesianPassiveVsActive_matched_information.gif
author:
  - name: Luděk Stehlík
...
Almost four years ago, I shared a [small animation](https://blog-about-people-analytics.netlify.app/posts/2022-10-27-bayesian-belief-updating/){target="_blank"} illustrating Bayesian belief updating using a billiards-table thought experiment described in [Philip Tetlock’s](https://en.wikipedia.org/wiki/Philip_E._Tetlock){target="_blank"} book [*Superforecasting*](https://en.wikipedia.org/wiki/Superforecasting:_The_Art_and_Science_of_Prediction){target="_blank"}.
...
![](./bayesianBelifUpdating.gif){width=100%}
</div>
...
<div style="text-align:center">
![](./bayesianPassiveVsActive_matched_information.gif){width=100%}
</div>
...
This general principle is related to ideas in [active learning](https://en.wikipedia.org/wiki/Active_learning_(machine_learning)){target="_blank"}, [optimal experimental design](https://en.wikipedia.org/wiki/Optimal_experimental_design){target="_blank"}, [information gain](https://en.wikipedia.org/wiki/Information_gain_(decision_tree)){target="_blank"}, and - importantly for my psychometrics lecture - also in already mentioned [computerized adaptive testing (CAT)](https://en.wikipedia.org/wiki/Computerized_adaptive_testing){target="_blank"}.
