...
description: |
  How listening to a podcast inspired me to try out a statistical tool popular among sociologists. 
preview: ./scheme.png
author:
  - name: Luděk Stehlík
...
Compared to other methods used in this context, such as Factor Analysis, k-means, or hierarchical clustering, it has several advantages:
...
As is clear from the above, this tool lends itself naturally to identifying subgroups of people with similar world/workviews and should therefore have a place in the toolkit of any employee survey analyst. 
