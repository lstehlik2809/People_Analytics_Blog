...
<object data="Gender-Pay-Gap-actions.pdf" type="application/pdf" height="400px">
    <embed src="Gender-Pay-Gap-actions.pdf">
        <p>Tento prohlížeč nepodporuje soubory PDF. Pro zobrazení si, prosím, PDF soubor stáhněte: <a href="Gender-Pay-Gap-actions.pdf.pdf">Stáhnout PDF</a>.</p>
    </embed>
</object>
<br>

Skript k analýze je k dispozici ke stažení v podobě Jupyter Notebooku na mých [GitHub](https://github.com/lstehlik2809/gender-pay-gap-analysis) stránkách.
