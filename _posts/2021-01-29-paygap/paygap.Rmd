...
```{r, layout="l-body-outset", code_folding=TRUE, message=FALSE, warning=FALSE, echo=FALSE}
...
```{r, code_folding=TRUE, message=FALSE, warning=FALSE, echo=FALSE}
...
```{r, layout="l-body-outset", code_folding=TRUE, message=FALSE, warning=FALSE, echo=FALSE, fig.height=18, fig.width=18}
...
```{r, code_folding=TRUE, message=FALSE, warning=FALSE, echo=FALSE, fig.width = 7, fig.height = 5}
...
```{r, code_folding=TRUE, message=FALSE, warning=FALSE, echo=FALSE, include=FALSE}
...
Skript k analýze je k dispozici ke stažení v podobě Jupyter Notebooku na mém [GitHub](https://github.com/lstehlik2809/gender-pay-gap-analysis) účtu.
