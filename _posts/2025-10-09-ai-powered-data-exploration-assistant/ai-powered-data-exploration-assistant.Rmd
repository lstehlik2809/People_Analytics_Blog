...
P.S. If you’re interested, you can grab the code behind the app from my [GitHub repo](https://github.com/lstehlik2809/AI-Powered-Data-Exploration){target="_blank"}. Just plug in your Gemini API key, and you can play around with your own data locally.