...
Recently, I happened to stumble across some data I collected during my general psychology lab sessions with my students, where we explored whether our faces really show traces of our personalities.
...
final_plot + 
  plot_annotation(caption = "The horizontal lines represent the 50%, 80%, and 95% credible intervals, respectively.")
