...
If interested, you can find below the data and code for replicating this analysis.
...
# uploading the data from the DataBank of the World Bank Group (https://databank.worldbank.org/)
