...
Given these results, one should feel motivated to identify among the mix of additive and multiplicative factors affecting one's performance those with multiplicative effects and try to bring them at least to the average level. The question is how one can easily identify which these are. Any tips?
