...
description: |
  Why our new pulse architecture isn't a methodological downgrade, and what Difference-in-Differences with Double Machine Learning has to do with it. 
preview: ./Comparison-of-repeated-cross-sectional-and-panel-design-studies-dots-represent-survey.png
author:
  - name: Luděk Stehlík
...
The substantive finding isn't the point. The methodological anchor is: they use an estimator proposed by [Zimmert (2020)](https://arxiv.org/abs/1809.01643){target="_blank"}, called **DiDDML** (Difference-in-Differences with Double Machine Learning), built specifically for repeated cross-sections. It combines:
...
The paper adapts a technique from [Callison and Kaestner (2014)](https://doi.org/10.1111/ecin.12027){target="_blank"}: **assign placebo treatments to random control units, estimate the effect, and check that placebo effects cluster around zero.** This is a discipline worth building into every internal causal claim as a mandatory robustness check.
...
The shift to pulse-based listening feels like a methodological downgrade because we lose the individual panel. It isn't. What we gain is data whose structure matches a well-developed modern causal inference toolkit, one most I/O curricula don't cover because it grew up in econometrics. The paper that pointed me at it was about cigarettes. What we do with it is about us.