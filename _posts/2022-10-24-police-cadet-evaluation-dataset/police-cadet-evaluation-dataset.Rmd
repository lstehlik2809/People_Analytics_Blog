...
Here is a table with the data. You can use it to check and download the data.
...
If you want to download the dataset, you can do so here via the table above or via [my GitHub account](https://github.com/lstehlik2809/Police-Cadet-Evaluation-Dataset) where you can also find more information about the dataset. Happy analysis 😉 
