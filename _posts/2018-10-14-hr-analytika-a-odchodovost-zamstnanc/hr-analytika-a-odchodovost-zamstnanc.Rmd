...
unmpl_data <- read_xlsx("C:/Users/lstehlik/Documents/_WORKFORCE_ANALYTICS/People_Analytics_Blog_Prep/HRA_Employee_Turnover_Dashboard/BLS_Unemployment_Rates.xlsx", 
                       sheet = "Unemployment Rate", col_names = TRUE)

quits_data <- read_xlsx("C:/Users/lstehlik/Documents/_WORKFORCE_ANALYTICS/People_Analytics_Blog_Prep/HRA_Employee_Turnover_Dashboard/BLS_Quits_Rates.xlsx")

# Priprava dat na vizualizaci -------------------------------------------------------------------
...
colnames(quits_data) <- quits_data[1,]
...
# Zmena formatu dat z sirokeho na dlouhy
...
mydata %>%
  ggplot(aes(x = Date)) +
  geom_line(aes(y = Quits_Rate, color = "Míra dobrovolné odchodovosti"), size = 1.5) +
  geom_line(aes(y = Unmpl_Rate/5, color = "Míra nezaměstnanosti"), size = 1.5) +
  ...
  labs(title = "Vztah mezi mírou nezaměstnanosti a dobrovolné odchodovosti",
...
# cor.test(mydata$Quits_Rate, mydata$Unmpl_Rate)
```
