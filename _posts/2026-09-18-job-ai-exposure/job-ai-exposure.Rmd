...
description: |
  I built a small app to explore that using data from the U.S. Bureau of Labor Statistics and O*NET.
preview: ./app_pic.jpg
author:
  - name: Luděk Stehlík
...
As part of a recent training on using AI effectively, I created Work & AI - a [small app](https://lstehlik2809.github.io/work-and-ai/){target="_blank"} for anyone curious about how AI might affect our jobs.
...
<figure style="text-align:center;">
  <img src="./app_pic2.png" style="width:100%;">
</figure>
...
If you want to play with it, go [here](https://lstehlik2809.github.io/work-and-ai/){target="_blank"}.
