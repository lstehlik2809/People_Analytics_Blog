...
description: |
  About another example of how generative AI is commoditizing previously specialized data products - this time, turning Outlook calendar data into a simple collaboration ego-network. 
preview: ./calendar_ego_network_pic.png
author:
  - name: Luděk Stehlík
...
P.S. To get a better sense of how the app works, you can check it out [here](https://lstehlik2809.github.io/calendar-ego-network-app/){target="_blank"} using sample calendar data.

<div style="text-align:center">
![](./meeting_network_app_demo_light.gif){width=100%}
</div>
