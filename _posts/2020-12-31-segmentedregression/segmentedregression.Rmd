...
modelWorkLifeBalance %>%
  ...
  ggplot2::labs(
    title = "Posterior distribution of the pandemicBeforethepandemicoutbreak parameter in the modelWorkLifeBalance"
    )
...
modelWellBeing %>%
  ...
  ggplot2::labs(
    title = "Posterior distribution of the pandemicBeforethepandemicoutbreak parameter in the modelWellBeing"
    )
...
The whole script is available in [the Jupyter Notebook on my GitHub site](https://github.com/lstehlik2809/Bayesian-segmented-regression.git).  
