...
Update: With more than 140 people completing the test, I was able to compare our current results with those of the participants in the original study. You can see the results of the comparison in the newer post *Evaluation of the results of the evidence-based HRM knowledge test*. Spoiler: It’s not very good `r emoji::emoji("hushed")`
