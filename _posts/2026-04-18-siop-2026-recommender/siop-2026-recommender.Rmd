...
Give it a try and let me know whether it makes your SIOP planning at least a little bit easier. In my case, it helped a lot 🤓 You can access it [here](https://siop-recommender-48217563872.europe-west1.run.app/){target="_blank"}, or for now, just check the screenshots below (double-click any slide to zoom in).
