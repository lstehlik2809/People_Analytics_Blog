...
In addition to the main question addressed here, we may be interested in other insights provided by the model. To this end, we can plot the marginal effect of each predictor. 
...
* Equally unsurprisingly, within each year, search interest is driven by the seasonality of work and holidays, i.e. search interest is lower during the holiday season - June, July, August and December - and higher for the rest of the year. 
