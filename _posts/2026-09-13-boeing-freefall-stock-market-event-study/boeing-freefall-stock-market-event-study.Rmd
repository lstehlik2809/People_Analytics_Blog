...
description: |
  Netflix’s "Freefall: A Reckoning for Boeing" documentary changed how I saw a company I personally had long admired, mainly for its major role in space exploration. I wondered whether others shared that reaction more broadly, and whether it might show up in Boeing’s share price. So I tested it 🧐
preview: ./documentary_pic.jpg
author:
  - name: Luděk Stehlík
...
<figure style="text-align:center;">
  <img src="./linkedin_freefall_car.png" style="width:100%;">
</figure>
...
<figure style="text-align:center;">
  <img src="./linkedin_comparative_car_vertical.png" style="width:100%;">
</figure>
...
P.S. For reproducibility, you can find the data sources, scripts, results, and step-by-step instructions for reproducing this analysis on [my GitHub](https://github.com/lstehlik2809/boeing-freefall-stock-market-event-study){target="_blank"}.
